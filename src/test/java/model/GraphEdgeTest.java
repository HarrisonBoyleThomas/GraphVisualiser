...
public class GraphEdgeTest{
	...
	**/
	...
	public void lengthTest(){
		...
		for(int i = 0; i < 100000; i++){
			assertEquals(i, edge.setLength(i, false));
			assertEquals(i, edge.getLength());
		}

		assertEquals(0, edge.setLength(-1, false));
		assertEquals(0, edge.getLength());

		assertEquals(100000, edge.setLength(100001, false));
	...
	**/
	...
	public void nameTest(){
		GraphEdge edge = new GraphEdge(nodeA, nodeB, 0);
		assertEquals("General Kenobi", edge.setName("General Kenobi", false));
