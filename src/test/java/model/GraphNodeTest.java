...
public class GraphNodeTest{
	...
	**/
	...
	public void defaultConstructorTest(){
		...
		assertEquals("New node", nodeA.getName());
	...
	**/
	...
	public void nameTest(){
		assertEquals("Hello there", nodeA.setName("Hello there", false));
	...
	**/
	...
	public void valueTest(){
		assertEquals(0, nodeA.getValue());
		assertEquals(1, nodeA.setValue(1, false));
		assertEquals(1, nodeA.getValue());

		assertEquals(-1, nodeA.setValue(-1, false));
		assertEquals(-1, nodeA.getValue());

		assertEquals(100000, nodeA.setValue(100000, false));
